...
<script>
import Popper from 'xxgcs-element-ui/src/utils/vue-popper';
import Clickoutside from 'xxgcs-element-ui/src/utils/clickoutside';
import Emitter from 'xxgcs-element-ui/src/mixins/emitter';
import Locale from 'xxgcs-element-ui/src/mixins/locale';
import Migrating from 'xxgcs-element-ui/src/mixins/migrating';
import ElInput from 'xxgcs-element-ui/packages/input';
import ElTag from 'xxgcs-element-ui/packages/tag';
import ElScrollbar from 'xxgcs-element-ui/packages/scrollbar';
import ElCascaderPanel from 'xxgcs-element-ui/packages/cascader-panel';
import AriaUtils from 'xxgcs-element-ui/src/utils/aria-utils';
import { t } from 'xxgcs-element-ui/src/locale';
import { isEqual, isEmpty, kebabCase } from 'xxgcs-element-ui/src/utils/util';
import { isUndefined, isFunction } from 'xxgcs-element-ui/src/utils/types';
import { isDef } from 'xxgcs-element-ui/src/utils/shared';
import { addResizeListener, removeResizeListener } from 'xxgcs-element-ui/src/utils/resize-event';
