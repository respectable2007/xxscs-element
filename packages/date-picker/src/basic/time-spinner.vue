...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from 'xxgcs-element-ui/src/utils/date-util';
  import ElScrollbar from 'xxgcs-element-ui/packages/scrollbar';
  import RepeatClick from 'xxgcs-element-ui/src/directives/repeat-click';
