...
<script type="text/babel">
  ...
  import { isDate, range, getDayCountOfMonth, nextDate } from 'xxgcs-element-ui/src/utils/date-util';
  import { hasClass } from 'xxgcs-element-ui/src/utils/dom';
  import { arrayFindIndex, coerceTruthyValueToArray, arrayFind } from 'xxgcs-element-ui/src/utils/util';
