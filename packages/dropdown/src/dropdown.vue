<script>
  ...
  import ElButton from 'xxgcs-element-ui/packages/button';
  import ElButtonGroup from 'xxgcs-element-ui/packages/button-group';
  import { generateId } from 'xxgcs-element-ui/src/utils/util';
